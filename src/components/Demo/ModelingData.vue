      ...
      <b-col md="10" xl="8">
        ...
        <div class="w-50 mt-4">
          ...
          <div class="text-input-example">
            ...
            <div><code>message: "{{ message }}"</code></div>
          </div>
        </div>
        ...
        <div class="checkbox-boolean mt-5">
          ...
          <label for="checkbox" class="ml-3"><code>checked: {{ checked }}</code></label>
        </div>
        ...
        <div class="checkbox-multiple mt-5">
          ...
          <p><code>selectedNames: {{ selectedNames }}</code></p>
        </div>
        ...
        <div class="select-example-single mt-5">
          ...
          <p><code>selectedName: "{{ selectedName }}"</code></p>
        </div>
...
import { gettingStartedTemplate, gettingStartedCode } from '../../data/snippets';
